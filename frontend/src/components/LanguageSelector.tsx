  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors">{currentLanguageObj.label}</span>
              ...
              {Object.values(LANGUAGE_CONFIG).map((lang, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="flex-1 text-left group-hover:text-white transition-colors">{lang.label}</span>
