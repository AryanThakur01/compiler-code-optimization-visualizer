      ...
      const animateLine = () => {
        ...
        const charInterval = setInterval(() => {
          if (charIndex < currentLineText.length) {
            tempOutput += currentLineText[charIndex]
            setVisibleOutput(tempOutput + '\u2588')
            charIndex++
          } else {
      ...
      <div className="rounded-xl overflow-hidden ring-1 ring-white/[0.05] h-[600px] relative">
        {isRunning ? (
          ...
          <div ref={scrollRef} className="relative h-full overflow-y-auto">
            <pre className="absolute inset-0 z-0 text-gray-500/30 whitespace-pre-wrap p-4 font-mono overflow-auto pointer-events-none">
