...
//                       <SelectTrigger className="w-[120px] p-2 bg-card text-foreground rounded-lg shadow-2xl">
...
//                   className="flex-grow min-h-[609px] p-3 bg-background text-foreground rounded-lg resize-none font-mono"
//                   style={{
//                     fontSize: 14,
//                     lineHeight: '1.3rem',
...
//                   value={optimizedCode}
//                   readOnly
//                   className="flex-grow min-h-[681px] p-3 bg-background text-foreground rounded-lg resize-none"
//                   style={{
//                     fontSize: 14,
//                     fontFamily: 'monospace',
//                   }}
...
//               <div className="text-2xl">
//                 <Select onValueChange={setSelectedLanguage} value={selectedLanguage}>
//                   <SelectTrigger className="w-[120px] p-2 bg-secondary text-secondary-foreground rounded-lg shadow-2xl">
//                     <SelectValue placeholder="Select Language" />
//                   </SelectTrigger>
...
//               }}
//               placeholder="Paste your code here....."
//               className="flex-grow min-h-[671px] p-3 bg-background text-foreground rounded-lg resize-none font-mono"
//               style={{
//                 fontSize: 14,
//                 fontFamily: 'monospace',
//               }}
