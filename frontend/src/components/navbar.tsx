...
export const Navbar = () => {
  return (
    <nav className="w-full fixed top-0 left-0 z-50 p-4 flex justify-between items-center bg-sidebar text-sidebar-foreground shadow-md border-b border-sidebar-border">
      ...
      <Link to="/about" className="group flex items-center gap-3 relative">
        <div
          className="absolute -inset-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg opacity-0 
          group-hover:opacity-100 transition-all duration-500 blur-xl"
        />
        ...
        <div
          ...
          ring-white/10 group-hover:ring-white/20 transition-all"
        >
          <UsersRound className="size-6 text-blue-400 transform -rotate-6 group-hover:rotate-0 transition-transform duration-500" />
        </div>
